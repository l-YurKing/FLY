...
//		if( error>0 ) pid->intergral *= 0.9f; // 微调减少积分，防止累积误差
	}
...
PIDControllerType_t RollRatePID = {
	...
	.ki = 0.0f,
	.kd = 0.0f,
	.LimitIntegralMax = 3.5f,   // 积分限幅,200度/s
	.LimitIntegralMin = -3.5f, 
	.LimitOutputMax = 500.0f,   // 角速度环输出为限幅值
	.LimitOutputMin = -500.0f,
	.IntegralThreshold = 0.35f , // 20度/s开始积分
	.alpha = 0.8f,
	.prev_error = 0,
	.intergral = 0,
	.derivative = 0,
...
PIDControllerType_t RollPID = {
	...
	.LimitIntegralMin = -0.52f,    // 积分限幅,30度
	.LimitOutputMax = 1.7f,      // 角速度输出,最大为 100度/s
	.LimitOutputMin = -1.7f,
	.IntegralThreshold = 0.2f ,  // 10度开始积分有效
	.alpha = 0.9f,
	.prev_error = 0,
	.intergral = 0,
	.derivative = 0,
...
PIDControllerType_t YawRatePID = {
	...
	.ki = 0.0f,
	.kd = 0.0f,
	.LimitIntegralMax = 1.04f,   // 积分限幅,60度/s
	.LimitIntegralMin = -1.04f, 
	.LimitOutputMax = 500,
	.LimitOutputMin = -500,
	.IntegralThreshold = 0.17f , // 10度/s开始积分
	.alpha = 0.8,
	.prev_error = 0,
	.intergral = 0,
	.derivative = 0,
...
PIDControllerType_t YawPID = {
	...
	.LimitIntegralMax = 0.52f,
	.LimitIntegralMin = -0.52f,    // 积分限幅,30度
	.LimitOutputMax = 3.7f,      // 角速度输出,最大为 100度/s
	.LimitOutputMin = -3.7f,
	.IntegralThreshold = 0.2f ,  // 10度开始积分有效
	.alpha = 1.0f,
	.prev_error = 0,
